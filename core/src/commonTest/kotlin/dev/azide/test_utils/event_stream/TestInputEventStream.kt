...
import dev.azide.internal.event_stream.EventStreamVertex.Emission
import dev.azide.internal.event_stream.abstract_vertices.AbstractLiveEventStreamVertex
...
internal class TestInputEventStream<EventT>() : EventStream<EventT> {
    ...
    fun revokeEmission(): TestInputStimulation = object : TestInputStimulation {
        override fun stimulate(
            propagationContext: Transactions.PropagationContext,
        ) {
