...
class Cell_map2_tests {
    ...
    fun test_passiveSample() {
        val sourceCell1 = _root_ide_package_.dev.azide.core.test_utils.cell.CellTestUtils.createInputCell(
            initialValue = 10,
        )

        val sourceCell2 = _root_ide_package_.dev.azide.core.test_utils.cell.CellTestUtils.createInputCell(
            initialValue = 'A',
        )
