...
import dev.azide.core.test_utils.schedules.ScheduleTestUtils_start_quickCancelledRevoked
...
class ReactiveList_syncing_start_quickCancelledRevoked_tests {
    ...
    fun test_start_quickCancelledRevoked() {
        ...
        ScheduleTestUtils_start_quickCancelledRevoked.executeStartTransaction(
