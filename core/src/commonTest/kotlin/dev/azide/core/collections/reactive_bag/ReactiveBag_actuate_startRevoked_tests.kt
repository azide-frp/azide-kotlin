...
import dev.azide.core.test_utils.effect_reactive_bag.Effect_ReactiveBag_startRevoked_testUtils
...
class ReactiveBag_actuate_startRevoked_tests {
    ...
    private fun test_startRevoked_sourceEffectBagChanges_addedOnly(
    ...
    private fun test_startRevoked_sourceEffectBagChanges_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChanges_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
    ...
    @Test
    fun test_startRevoked_sourceEffectBagChanges_nonObserved() {
        test_startRevoked_sourceEffectBagChanges_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChanges,
        )
    }

    private fun test_startRevoked_sourceEffectBagChanges_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesRevoked_addedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesRevoked_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesRevoked_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2a = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_sourceEffectBagChangesRevoked_nonObserved() {
        test_startRevoked_sourceEffectBagChangesRevoked_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChangesRevoked,
        )
    }

    private fun test_startRevoked_sourceEffectBagChangesRevoked_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesCorrected_addedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesCorrected_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    private fun test_startRevoked_sourceEffectBagChangesCorrected_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2a = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_sourceEffectBagChangesCorrected_nonObserved() {
        test_startRevoked_sourceEffectBagChangesCorrected_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChangesCorrected,
        )
    }

    private fun test_startRevoked_sourceEffectBagChangesCorrected_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
