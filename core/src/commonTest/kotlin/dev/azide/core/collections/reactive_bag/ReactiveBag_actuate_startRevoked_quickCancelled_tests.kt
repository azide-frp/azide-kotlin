...
import dev.azide.core.test_utils.effect_reactive_bag.Effect_ReactiveBag_startRevoked_quickCancelled_testUtils
...
class ReactiveBag_actuate_startRevoked_quickCancelled_tests {
    ...
    fun test_startRevoked_quickCancelled() {
        ...
        Effect_ReactiveBag_startRevoked_quickCancelled_testUtils.testStart(
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChanges_observed_addedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChanges.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChanges_addedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChanges_addedOnly(
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChanges_observed_removedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChanges.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChanges_removedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChanges_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChanges_observed_replacedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChanges.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChanges_replacedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChanges_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChanges_observed_mixed() {
        slottedStimulationScenarioBank_sourceEffectBagChanges.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChanges_mixed(
                slottedStimulationScenario = it,
            )
        }
    }
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChanges_nonObserved() {
        test_startRevoked_quickCancelled_sourceEffectBagChanges_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChanges,
        )
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChanges_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_observed_addedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesRevoked.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_addedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_addedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_observed_removedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesRevoked.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_removedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_observed_replacedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesRevoked.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_replacedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2a = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_observed_mixed() {
        slottedStimulationScenarioBank_sourceEffectBagChangesRevoked.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_mixed(
                slottedStimulationScenario = it,
            )
        }
    }
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_nonObserved() {
        test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChangesRevoked,
        )
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesRevoked_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_observed_addedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesCorrected.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_addedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_addedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_observed_removedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesCorrected.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_removedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_removedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1 = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_observed_replacedOnly() {
        slottedStimulationScenarioBank_sourceEffectBagChangesCorrected.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_replacedOnly(
                slottedStimulationScenario = it,
            )
        }
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_replacedOnly(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2a = TestTargetEffect.pure(result = 20)
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_observed_mixed() {
        slottedStimulationScenarioBank_sourceEffectBagChangesCorrected.forEach {
            test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_mixed(
                slottedStimulationScenario = it,
            )
        }
    }
    ...
    @Test
    fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_nonObserved() {
        test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_mixed(
            slottedStimulationScenario = arbitrarySlottedStimulationScenario_sourceEffectBagChangesCorrected,
        )
    }

    private fun test_startRevoked_quickCancelled_sourceEffectBagChangesCorrected_mixed(
        slottedStimulationScenario: SuitableTestSlottedStimulationScenario,
    ) {
        val targetEffect1a = TestTargetEffect.pure(result = 10)
        val targetEffect2 = TestTargetEffect.pure(result = 20)
