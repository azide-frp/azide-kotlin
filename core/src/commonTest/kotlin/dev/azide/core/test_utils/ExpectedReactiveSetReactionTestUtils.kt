...
typealias ExpectedReactiveSetReaction<ElementT> = ExpectedTestSubjectReaction<ReactiveSet<ElementT>, TestReactiveSetObserver<ElementT>>

object ExpectedReactiveSetReactionTestUtils {
    fun <ElementT> expectChange(
        expectedNewElements: Set<ElementT>,
    ): ExpectedReactiveSetReaction<ElementT> = object : ExpectedReactiveSetReaction<ElementT> {
        override fun prepareDeltaVerifier(
            ...
            val oldContent = subjectProxy.observedReactiveSetVertex.getOldContentCopy(
        ...
        override fun prepareNewStateVerifier(
            ...
            return object : ExpectedTestSubjectReaction.NewStateVerifier {
                override fun verifyNewState(
                    ...
                    val newContent = subject.vertex.getOldContentCopy(
                        propagationContext = propagationContext,
                    )
    ...
    fun <ElementT> expectNoChange(
        ...
        override fun prepareNewStateVerifier(
            ...
            val originalContent = subject.vertex.getOldContentCopy(
                propagationContext = propagationContext,
            )
