...
/**
 * A stimulation strategy in which the input is stimulated in a transaction following the transaction in which the test
 * subject is perceived.
 */
object PerceivedUpFrontStimulationTestStrategy : StimulationTestStrategy {
    override fun <SubjectT, SubjectProxyT> verifyStimulationEffectiveness(
        ...
        val subjectProxy = Transactions.executeWithResult { propagationContext ->
            subjectPerceptionTrait.perceive(
