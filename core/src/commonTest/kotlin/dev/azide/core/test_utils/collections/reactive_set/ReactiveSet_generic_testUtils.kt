...
data object ReactiveSet_generic_testUtils {
    ...
    val stimulationScenarioBank_sourceSetChanges = TestStimulationScenarioBank_deprecated.mixAll(
        TestInputReactiveCollectionTag.changeScenario(
            inputReactiveCollectionTag = SourceReactiveSetTag,
        ),
    )

    val stimulationScenarioBank_sourceSetChangesRevoked = TestStimulationScenarioBank_deprecated.mixAll(
        TestInputReactiveCollectionTag.revokedChangeScenario(
            inputReactiveCollectionTag = SourceReactiveSetTag,
        ),
    )

    val stimulationScenarioBank_sourceSetChangesCorrected = TestStimulationScenarioBank_deprecated.mixAll(
