...
import dev.azide.internal.FinalizationTransactionRegistry
import dev.azide.internal.Transaction
...
fun <EventT> BasicSubscriber<EventT>.weaklyReferenced(): LiveEventStreamVertex.WeaklyReferencedSubscriber<EventT> =
...
fun <EventT> LiveEventStreamVertex<EventT>.registerLooseSubscriber(
    ...
    subscriber: BasicSubscriber<EventT>,
): LooseSubscription {
    ...
    return object : LooseSubscription {
        override fun cancel() {
