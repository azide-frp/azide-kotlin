...
import dev.azide.internal.event_stream.LiveEventStreamVertex.Subscriber
import dev.azide.internal.event_stream.LiveEventStreamVertex.SubscriberStatus
...
abstract class AbstractLiveEventStreamVertex<EventT> : LiveEventStreamVertex<EventT>, CommittableVertex {
    ...
    private val _registeredSubscribers: MutableBag<Subscriber<EventT>> = MutableBag()
