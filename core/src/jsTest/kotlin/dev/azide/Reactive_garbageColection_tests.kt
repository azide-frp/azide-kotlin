...
import dev.azide.event_stream.EventStream_hold_garbageCollection_testGroup
import dev.azide.event_stream.EventStream_single_garbageCollection_testGroup
import dev.azide.test_utils.JsGarbageCollectorUtils
import dev.azide.test_utils.JsGarbageCollectorUtils.withContinuousGarbageCollectorPressure
import dev.azide.test_utils.async.AsyncTestSuite
...
class Reactive_garbageCollection_tests {
    ...
    fun test_garbageCollection() = runTest {
        withContinuousGarbageCollectorPressure(config = config) {
